...
int main() {
    ...
    cout << "Tempo médio de execução do Bubble Sort (" << num_executions << " execuções): " << average << " microssegundos" << endl;
    ...
    cout << "Desvio padrão de execução do Bubble Sort (" << num_executions << " execuções): " << standard_deviation << " microssegundos" << endl;
